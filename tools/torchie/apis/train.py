...
import numpy as np
import torch
from tools.builder import _create_learning_rate_scheduler

# from tools.datasets.kitti.eval_hooks import KittiDistEvalmAPHook, KittiEvalmAPHookV2
from tools.core import DistOptimizerHook
from tools.datasets import build_dataloader
from tools.solver.fastai_optim import OptimWrapper
from tools.torchie.trainer import DistSamplerSeedHook, Trainer, obj_from_dict
from tools.utils.print_utils import metric_to_str
...
def train_detector(model, dataset, cfg, distributed=False, validate=False, logger=None):
    ...
    #     dataset_name = DATASETS.get(val_dataset_cfg.type)
