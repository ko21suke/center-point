...
from tools.core.bbox import box_np_ops
from tools.core.sampler import preprocess as prep
from tools.builder import build_dbsampler

from tools.core.input.voxel_generator import VoxelGenerator
from tools.core.utils.center_utils import (
...
class Voxelization(object):
    def __init__(self, **kwargs):
        ...
        # ex: [-51.2, -51.2, -5.0, 51.2, 51.2, 3.0],
    ...
    def __call__(self, res, info):
        ...
        if res["mode"] == "train":
            ...
            # pc range is [min_x, min_y, min_z, max_x, max_y, max_z
            # -> so bv range is [min_x, min_y, max_x, max_y]
        ...
        """
        # The Voxels have the points which are in the each voxel
        voxels = voxels[:voxel_num]
        # The coordinates of the each points based on the voxel grid scale,
        coordinates (coors = coors[:voxel_num])
