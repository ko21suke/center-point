...
from tools.datasets.custom import PointCloudDataset
from tools.datasets.nuscenes.common import (
...
class NuScenesDataset(PointCloudDataset):
    NUM_POINT_FEATURES = 5  # x, y, z, intensity, ring_index
    def __init__(
        self,
        info_path,
        root_path,
        num_sweeps=0, # here set to zero to catch unset num_sweeps
        cfg=None,
        pipeline=None,
        class_names=None,
        test_mode=False,
        ...
        **kwargs,
        ...
        assert self.num_sweeps > 0, "At least input one sweep please!"
        ...
        self._num_point_features = NuScenesDataset.NUM_POINT_FEATURES
    ...
    def get_sensor_data(self, idx):
        """
        Return res which has voxel data which has points data.
        """
