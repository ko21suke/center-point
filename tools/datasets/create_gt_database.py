...
from datasets import box_np_ops
    ...
    **kwargs,
    ...
    if dataset_class_name in ["WAYMO", "NUSC"]:
        ...
        if dbinfo_path is None:
            if virtual:
                dbinfo_path = root_path / f"dbinfos_train_{num_sweeps}sweeps_withvelo_virtual.pkl"
            else:
                dbinfo_path = root_path / f"dbinfos_train_{num_sweeps}sweeps_withvelo.pkl"
    else:
